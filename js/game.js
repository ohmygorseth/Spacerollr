...
function nextLevel(){
  ...
  if(gameMode==='main'&&currentLevel+1<LEVELS.length){
    currentLevel++;camZ=0;px=0;pvx=0;jy=0;jvy=0;pts=[];rot=0;track=[];tBase=0;spd=CONFIG.BASE_SPEED;state='play';growTrack(0);
  } else {
    completeLevel(currentLevel);
